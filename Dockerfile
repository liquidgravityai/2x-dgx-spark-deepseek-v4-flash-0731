...
LABEL org.opencontainers.image.title="DeepSeek V4 Flash 0731 for 2x DGX Spark with SGLang" \
      org.opencontainers.image.description="Qualified two-node SGLang r7 runtime with bounded hybrid-SWA eviction, DSpark speculative decoding, and profiled compact verification for NVIDIA DGX Spark" \
      ...
      org.opencontainers.image.version="0731-r7-sglang-d2c405f-flashinfer-67f7637-cu132" \
